...
(function () {
    ...
    var y, B = document, K = window, W = Math, r = W.round, V = W.floor, ta = W.ceil, u = W.max, C = W.min, O = W.abs,
        X = W.cos, aa = W.sin, ma = W.PI, ha = ma * 2 / 360, Ba = navigator.userAgent, Jb = K.opera,
        ya = /(msie|trident)/i.test(Ba) && !Jb, hb = B.documentMode === 8, ib = /AppleWebKit/.test(Ba),
        La = /Firefox/.test(Ba), Kb = /(Mobile|Android|Windows Phone)/.test(Ba),
        Ca = "http://www.w3.org/2000/svg", ca = !!B.createElementNS && !!B.createElementNS(Ca, "svg").createSVGRect,
        Ob = La && parseInt(Ba.split("Firefox/")[1], 10) < 4, fa = !ca && !ya && !!B.createElement("canvas").getContext,
        $a, ab, Lb = {}, yb = 0, fb, T, Oa, za, zb, E, na = function () {
            return y
        }, Y = [], bb = 0, Ka = "div", P = "none", Pb = /^[0-9]+$/,
        jb = ["plotTop", "marginRight", "marginBottom", "plotLeft"], Qb = "stroke-width", Aa, gb, ob, eb, sb, tb, ub,
        Xa, Ya, Za, Eb, Fb, Gb, Hb, vb, wb, xb, M = {}, A;
    ...
    Oa = function (a, b, c) {
        ...
        var a = p(a, "%Y-%m-%d %H:%M:%S"), d = new Aa(b - Wa(b)), e, f = d[tb](), g = d[ub](), h = d[Xa](), i = d[Ya](),
            j = d[Za](), k = T.lang, l = k.weekdays, d = x({
                a: l[g].substr(0, 3),
                A: l[g],
                d: Ia(h),
                e: h,
    ...
    A.numberFormat = function (a, b,
        ...
        var e = T.lang, a = +a || 0,
            ...
            c = String(D(a = O(a).toFixed(f))), g = c.length > 3 ? c.length % 3 : 0;
    ...
    var kb = F.adapterRun, Rb = F.getScript, Ma = F.inArray, o = A.each = F.each,
        lb = F.grep, Sb = F.offset, Ua = F.map, H = F.addEvent, Z = F.removeEvent, I = F.fireEvent,
        Tb = F.washMouseEvent, mb = F.animate, db = F.stop;
    T = {
    ...
    ua.prototype = {
        Element: Q, init: function (a, b, c, d, e) {
            ...
            var j = this.label(a, b, c, i, null, null, null, null, "button"), k = 0, l, m, n, v, s, p,
            ...
            var e = da(a) ? a.r : e, g = this.createElement("rect"),
                a = da(a) ? a : a === y ? {} : {x: a, y: b, width: u(c, 0), height: u(d, 0)};
            ...
            var m = this, n = m.g(i), v = m.text("", 0, 0, g).attr({zIndex: 1}), s, p, N = 0, t = 3, w = 0, ga, u, Ab,
                C, B = 0, G = {}, A, D;
            n.onAdd = function () {
                v.add(n);
    ...
    if (!ca && !fa) {
        ...
        var Na = {
            ...
            isHidden: function () {
                ...
                return x(e, {
                    ...
                    getCSS: function (a) {
                        var b = a.element, c = b.nodeName, a = a.inverted,
                            ...
                            f = d + this.height,
                            d = {clip: "rect(" + r(a ? e : d) + "px," + r(a ? f : b) + "px," + r(a ? b : f) + "px," + r(a ? d : e) + "px)"};
                ...
                if (i) {
                    var k, l, m = a.linearGradient || a.radialGradient, n, v, s, p, N, t = "", a = a.stops, w, ga = [],
                        q = function () {
                    ...
                    if (c === "fill") if (i === "gradient") c = m.x1 || m[0] || 0, a = m.y1 || m[1] || 0, n = m.x2 || m[2] || 0, m = m.y2 || m[3] || 0, t = 'angle="' + (90 - W.atan((m - a) / (n - c)) * 180 / ma) + '"', q(); else {
                        var j = m.r, u = j * 2, y = j * 2, r = m.cx, x = m.cy, C = b.radialReference, z,
                            j = function () {
    ...
    Ta.prototype = {
        addLabel: function () {
            ...
            var b = this.axis, c = a.x, d = b.chart.chartWidth, e = b.chart.spacing, f = p(b.labelLeft, C(b.pos, e[3])),
                e = p(b.labelRight, u(b.pos + b.len, d - e[1])), g = this.label, h = this.rotation,
                i = {left: 0, center: 0.5, right: 1}[b.labelAlign], j = g.getBBox().width, k = b.slotWidth, l = 1, m,
                n = {};
            ...
            var d = this.axis, e = d.options, f = d.chart.renderer, g = d.horiz, h = this.type, i = this.label,
                ...
                v = e[m + "LineWidth"], s = e[m + "LineColor"], o = e[m + "LineDashStyle"], N = e[n + "Length"],
                m = e[n + "Width"] || 0, t = e[n + "Color"], w = e[n + "Position"], n = this.mark, ga = k.step, q = !0,
                u = d.tickmarkOffset, r = this.getPosition(g, j, u, b), x = r.x, r = r.y,
                z = g && x === d.pos + d.len || !g && r === d.pos ? -1 : 1, c = p(c, 1);
            this.isActive = !0;
            if (v) {
    ...
    A.PlotLineOrBand.prototype = {
        render: function () {
            var a = this, b = a.axis, c = b.horiz, d = a.options, e = d.label, f = a.label, g = d.width, h = d.to,
                i = d.from, j = q(i) && q(h), k = d.value,
                l = d.dashStyle, m = a.svgElem, n = [], v, s = d.color, p = d.zIndex, o = d.events, t = {},
                w = b.chart.renderer;
    ...
    va.prototype = {
        ...
        defaultLabelFormatter: function () {
            var a = this.axis, b = this.value, c = a.categories, d = this.dateTimeLabelFormat,
                e = T.lang.numericSymbols, f = e && e.length, g, h = a.options.labels.format,
        ...
        setTickInterval: function (a) {
            var b = this, c = b.chart, d = b.options, e = b.isLog, f = b.isDatetimeAxis, g = b.isXAxis, h = b.isLinked,
                i = d.maxPadding, j = d.minPadding, k = d.tickInterval, l = d.tickPixelInterval, m = b.categories;
        ...
        unsquish: function () {
            var a = this.ticks, b = this.options.labels,
                c = this.horiz, d = this.tickInterval, e = d,
        ...
        renderUnsquish: function () {
            var a =
                ...
                j = u(1, r(i - 2 * (e.padding || 5))), k = {}, g = b.fontMetrics(e.style.fontSize, d[0] && d[0].label),
                h = e.style.textOverflow, l, m = 0;
        ...
        getOffset: function () {
            var a = this, b = a.chart, c = b.renderer, d = a.options, e = a.tickPositions, f = a.ticks, g = a.horiz,
                h = a.side, i = b.inverted ? [1, 0, 3, 2][h] : h, j, k, l = 0, m, n = 0, v = d.title, s = d.labels,
                S = 0, N = b.axisOffset, b = b.clipOffset, t = [-1,
                    1, 1, -1][h], w;
            j = a.hasData();
        ...
        getTitlePosition: function () {
            var a = this.horiz, b = this.left, c = this.top, d = this.len, e = this.options.title, f = a ? b : c,
                g = this.opposite, h = this.offset, i = e.x || 0, j = e.y || 0, k = D(e.style.fontSize || 12),
        ...
        render: function () {
            var a = this, b = a.chart, c = b.renderer, d = a.options, e = a.isLog, f = a.isLinked, g = a.tickPositions,
                ...
                m = d.alternateGridColor, n = a.tickmarkOffset, v = d.lineWidth, s,
                p = b.hasRendered && q(a.oldMin) && !isNaN(a.oldMin), N = a.showAxis, t, w;
    ...
    Nb.prototype = {
        init: function (a, b) {
            ...
            var e = this, f = e.now, g = e.options.animation !==
                !1 && !e.isHidden && (O(a - f.x) > 1 || O(b - f.y) > 1), h = e.followPointer || e.len > 1;
            x(f, {
                x: g ? (2 * f.x + a) / 3 : a,
                y: g ? (f.y + b) / 2 : b,
            ...
            var d = this.chart,
                e = this.distance, f = {}, g = c.h || 0, h, i = ["y", d.chartHeight, b, c.plotY + d.plotTop],
                j = ["x", d.chartWidth, a, c.plotX + d.plotLeft],
                k = p(c.ttBelow, d.inverted && !c.negative || !d.inverted && c.negative), l = function (a, b, c, d) {
    ...
    Va.prototype = {
        init: function (a, b) {
            ...
            var b = this.chart, c = b.options.chart, d = a.chartX, e = a.chartY, f = this.zoomHor, g = this.zoomVert,
                ...
                n = this.mouseDownY, v = c.panKey && a[c.panKey + "Key"];
            d < h ? d = h : d > h + j && (d = h + j);
            e < i ? e = i : e > i + k && (e = i + k);
                ...
                if (this.hasDragged || d) o(c.axes, function (c) {
                    if (c.zoomEnabled && q(c.min) && (d || b[{xAxis: "zoomX", yAxis: "zoomY"}[c.coll]])) {
                        var f = c.horiz, n = a.type === "touchend" ? c.minPixelPadding : 0,
                            v = c.toValue((f ? g : h) + n), f = c.toValue((f ? g + i : h + j) - n);
    ...
    x(A.Pointer.prototype, {
        pinchTranslate: function (a, b, c, d, e, f) {
            ...
            var i = this.chart, j = a ? "x" : "y", k = a ? "X" : "Y", l = "chart" + k, m = a ? "width" : "height",
                n = i["plot" + (a ? "Left" : "Top")], v, s, p = h || 1, o = i.inverted, t = i.bounds[a ? "h" : "v"],
                w = b.length === 1, q = b[0][l], u = c[0][l], r = !w && b[1][l], y = !w && c[1][l], x, c = function () {
    ...
    nb.prototype = {
        init: function (a,
            ...
            var b = this.chart, c = b.renderer, d =
                ...
                l = !d.rtl, m = d.width, n = d.itemMarginBottom || 0, v = this.itemMarginTop, s = this.initialItemX,
                o = a.legendItem, q = a.series && a.series.drawLegendSymbol ? a.series : a, t = q.options,
                t = this.createCheckboxForItem && t && t.showCheckbox, w = d.useHTML;
            if (!o) {
            ...
            var b = this, c = this.chart, d = c.renderer, e = this.options, f = e.y,
                ...
                n = this.pages, v = this.padding, s, q = this.allItems, N = function (a) {
                    i.attr({height: a});
    ...
    F.prototype = {
        callbacks: [], init: function (a, b) {
            ...
            var b = this, c = b.options.chart, d = b.renderTo, e = c.width || kb(d, "width"),
                f = c.height || kb(d, "height"), c = a ? a.target : K, d = function () {
            ...
            var a = this.options.chart, b = this.renderer, c = this.chartWidth, d = this.chartHeight,
                ...
                m = a.plotBorderWidth ||
                    0, n, p = this.plotLeft, o = this.plotTop, q = this.plotWidth, u = this.plotHeight,
                t = this.plotBox, w = this.clipRect, r = this.clipBox;
            n = i + (a.shadow ? 8 : 0);
    ...
    var Yb = A.CenteredSeriesMixin = {
        getCenter: function () {
            var a = this.options,
                ...
                e = a.center, e = [p(e[0], "50%"), p(e[1], "50%"), a.size || "100%", a.innerSize || 0], f = C(d, b), g,
                h;
    ...
    R.prototype = {
        ...
        setData: function (a, b, c, d) {
            var e = this, f = e.points, g = f && f.length || 0, h, i = e.options, j = e.chart, k = null, l = e.xAxis,
                m = l && !!l.categories, n = i.turboThreshold, v = this.xData, s = this.yData,
                q = (h = e.pointArrayMap) && h.length, a = a || [];
            h = a.length;
            b = p(b, !0);
        ...
        drawPoints: function () {
            var a, b = this.points, c = this.chart, d, e, f, g, h, i, j, k, l = this.options.marker,
                m = this.pointAttr[""], n, v, o, r = this.markerGroup,
        ...
        drawGraph: function () {
            var a = this, b = this.options, c = [["graph",
                ...
                f = this.getGraphPath(), g = this.fillGraph && this.color || P;
        ...
        applyZones: function () {
            var a = this, b = this.chart, c = b.renderer, d = this.zones, e, f, g = this.clips || [], h, i = this.graph,
                j = this.area, k = u(b.chartWidth, b.chartHeight), l = this[(this.zoneAxis || "y") + "Axis"], m,
                n = l.reversed, v = b.inverted, s = l.horiz, q, x, t, w = !1;
    ...
    R.prototype.setStackedPoints = function () {
        if (this.options.stacking && !(this.visible !== !0 && this.chart.options.chart.ignoreHiddenSeries !== !1)) {
            var a = this.processedXData, b = this.processedYData, c = [], d = b.length, e = this.options,
                ...
                e = e.stacking, i = this.stackKey, j = "-" + i, k = this.negStacks, l = this.yAxis, m = l.stacks,
                n = l.oldStacks, o, s, q, r, t, w;
            for (r = 0; r < d; r++) {
                t = a[r];
                w = b[r];
                q = this.index + "," + r;
    ...
    x(R.prototype, {
        addPoint: function (a, b, c, d) {
            var e = this, f = e.options, g = e.data, h = e.graph, i = e.area, j = e.chart, k = e.xAxis && e.xAxis.names,
                l = h && h.shift || 0, m = ["graph", "area"], h = f.data, n, v = e.xData;
            Sa(d, j);
            if (c) {
    ...
    xa = ka(R, {
        ...
        getColumnMetrics: function () {
            ...
            var c = C(O(c.transA) * (c.ordinalSlope || b.pointRange || c.closestPointRange || c.tickInterval || 1), c.len),
                ...
                b = q(l) ? (k - l) / 2 : k * b.pointPadding, l = p(l, k - 2 * b);
        ...
        translate: function () {
            ...
            o(a.points, function (c) {
                var d = p(c.yBottom, f), h = 999 + O(d), h = C(u(-h, c.plotY), e.len + h), o = c.plotX + k, q = j,
                    t = C(h, d), w, x;
                w = u(h, d) - t;
    ...
    U = {
        ...
        translate: function (a) {
            ...
            var b = 0, c = this.options, d = c.slicedOffset, e = d + c.borderWidth, f, g, h, i = c.startAngle || 0,
                ...
                l = c.dataLabels.distance, c = c.ignoreHiddenPoint, m,
                n = k.length, o;
    ...
    R.prototype.alignDataLabel = function (a, b, c, d, e) {
        var f = this.chart, g = f.inverted, h = p(a.plotX, -999), i = p(a.plotY, -999), j = b.getBBox(),
            k = f.renderer.fontMetrics(c.style.fontSize).b, l = this.visible && (a.series.forceDL || f.isInsidePlot(h,
    ...
    if (M.pie) M.pie.prototype.drawDataLabels = function () {
        var a = this, b = a.data, c, d = a.chart, e = a.options.dataLabels, f = p(e.connectorPadding, 10),
            ...
            m = e.distance, n = a.center, q = n[2] / 2, s = n[1], x = m > 0, y, t, w, z = [[], []], B, A, D, F, G,
    ...
    if (M.column) M.column.prototype.alignDataLabel = function (a, b, c, d, e) {
        var f =
                this.chart.inverted, g = a.series, h = a.dlBox || a.shapeArgs,
    ...
    x(F.prototype, {
        showResetZoom: function () {
            var a = this, b = T.lang, c = a.options.chart.resetZoomButton, d = c.theme, e = d.states,
