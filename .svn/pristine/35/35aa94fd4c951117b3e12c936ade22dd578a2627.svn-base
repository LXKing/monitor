...
(function($){
	...
	_consts = {
		className: {
			...
			SWITCH: "switch spanname",
			NAME: 'node_name spanname'
		},
		event: {
	...
	_eventProxy = function(event) {
		...
		if (tools.eqs(event.type, "mousedown")) {
			...
			if (tools.eqs(target.tagName, "span span2") && target.getAttribute("treeNode"+ consts.id.SWITCH) !== null) {
