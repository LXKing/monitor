...
public interface DriverdlDao{
	 ...
	 * @return
	 */
    int updateDriverdl(@Param("enti") Driverdl value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyDriverdl(@Param("enti") Driverdl value, @Param("assist") Assist assist);
}