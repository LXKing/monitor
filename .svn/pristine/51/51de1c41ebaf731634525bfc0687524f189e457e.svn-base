...
public class ByteIO {
	...
	public BigInteger getUlong() {
		return BigInteger.valueOf(getLong()).and(
	...
	public BigInteger getUlong(int index) {
		return BigInteger.valueOf(getLong(index)).and(
				new BigInteger("FFFFFFFFFFFFFFFF", 16));
	}
	...
	public ByteIO putUlong(BigInteger value) {
		buffer.putLong(value.and(new BigInteger("ffffffffffffffff", 16))
				.longValue());
		return this;
	}
	...
	public ByteIO putUlong(int index, BigInteger value) {
		buffer.putLong(index, value.and(new BigInteger("ffffffffffffffff", 16))
				.longValue());
		return this;
	}
