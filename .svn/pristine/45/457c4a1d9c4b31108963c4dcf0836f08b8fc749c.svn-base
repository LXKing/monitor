package com.edata.godp.dao.drivingrecorder;
...
public interface IDrivingRecorderDao {
    ...
    List<SpeedLogDto> querySpeedLogPageDetail(String deviceNumber, Date start, Date end, int pageIndex, int pageSize) throws Exception;
}
