...
@RequiresPermissions("baseinfo.driver")
    ...
    @ResponseBody
    public ResponseEntity<Map<String, Object>> addSections(@RequestParam String driverId, @RequestParam String vl)
            throws Exception {
    ...
    @ResponseBody
    public ResponseEntity<Map<String, Object>> removeSection(@RequestParam String driverId, @RequestParam String vl)
            throws Exception {
        Assist a = new Assist();
