var Ren_sectionOverspeedCount = function (url) {
        ...
        if (obj.event === 'more') {
            ...
            var jjj = layer.open({
                ...
                , yes: function () {
                    ...
                    jQuery.ajax({
                        url: '/statistics/sectionOverspeedCountExport',
                        type: "POST",
                        data: params,
                        success: function (response, status, request) {

                            var url='/statistics/sectionOverspeedCountExport';
                ...
                success: function (layero, index) {
                    ...
                    table.render({
                        elem: '#detail'
                        , url: '/statistics/sectionOverspeedDetail', //数据接口
                        page: true, // 开启分页
                        method: "POST",
                        where: {
                            motorcade: data.motorcade,
