...
<head>
    ...
    <script type="text/javascript"
            src="<%=request.getContextPath()%>/resources/js/statistics/team/historyOnlineOffline.js"></script>
</head>
<body>
<div id="chart" style="height: 300px; width: 98%;"></div>
<div class="mon-toolbar metro-gray">
    <div class="title mon-3x">历史上线率统计</div>
...
<div id="gridHistoryVehicleOnline"></div>
</body>
</html>