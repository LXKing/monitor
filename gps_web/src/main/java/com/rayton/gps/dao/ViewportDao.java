...
public interface ViewportDao {
     ...
     * @return
     */
    int updateViewport(@Param("enti") Viewport value, @Param("assist") Assist assist);
     ...
     * @return
     */
    int updateNonEmptyViewport(@Param("enti") Viewport value, @Param("assist") Assist assist);
}