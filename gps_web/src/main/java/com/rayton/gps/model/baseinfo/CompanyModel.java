...
public class CompanyModel {
    ...
    public String toString() {
        return "CompanyModel{" + "id='" + id + '\'' + ", fullName='" + fullName + '\'' + ", shortName='" + shortName
                + '\'' + ", organCode='" + organCode + '\'' + ", registDate=" + registDate + ", corporation='" +
                corporation + '\'' + ", ondutyPhone='" + ondutyPhone + '\'' + ", officeAddress='" + officeAddress +
                '\'' + ", registAddress='" + registAddress + '\'' + ", parentVisible=" + parentVisible + ", " +
                "companyEditTime=" + companyEditTime + ", pid='" + pid + '\'' + ", companyId='" + companyId + '\'' +
                ", enums=" + kind + ", account='" + account + '\'' + ", name='" + name + '\'' + ", email='" + email +
                '\'' + ", phone='" + phone + '\'' + ", contact='" + contact + '\'' + ", enable=" + enable + ", " +
                "serviceStartDate=" + serviceStartDate + ", serviceEndDate=" + serviceEndDate + ", createTime=" +
                createTime + ", remark='" + remark + '\'' + ", userEditTime=" + userEditTime + '}';
    }
