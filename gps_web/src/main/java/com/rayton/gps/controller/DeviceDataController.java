...
public class DeviceDataController {
    ...
    @RequiresPermissions("mmp")
    @ServiceMethod(id = "mmp", prefix = "打开", name = "数据查询", suffix = "页面")
    ...
    @ServiceMethod(id = "center.deviceData.multimedia", pid = "center.deviceData", prefix = "打开", name = "多媒体数据",
            suffix = "页面")
    ...
    @ServiceMethod(id = "center.deviceData.multimediaEvent", pid = "center.deviceData", prefix = "打开", name =
            "多媒体事件", suffix = "页面")
    ...
    @ServiceMethod(id = "center.deviceData.multimediaRetrieval", pid = "center.deviceData", prefix = "打开", name =
            "多媒体数据检索", suffix = "页面")
    ...
    @ServiceMethod(id = "center.deviceData.deviceEventReport", pid = "center.deviceData", prefix = "打开", name =
            "事件报告", suffix = "页面")
    ...
    @ServiceMethod(id = "center.deviceData.deviceUpgradeResultReport", pid = "center.deviceData", prefix = "打开", name
            = "升级结果报告", suffix = "页面")
    ...
    public String pickupMultmedia(@RequestParam String deviceNumber, @RequestParam int mediaId, RedirectAttributes r,
    ...
    @ServiceMethod(id = "center.deviceData.drivingRecorder", pid = "center.deviceData", prefix = "打开", name =
            "行驶记录仪信息", suffix = "页面")
    ...
    @ServiceMethod(id = "center.deviceData.accidentDoubtLog", pid = "center.deviceData", prefix = "打开", name =
            "事故疑点日志", suffix = "页面")
    ...
    @ServiceMethod(id = "center.deviceData.powerLog", pid = "center.deviceData", prefix = "打开", name = "外部供电日志",
            suffix = "页面")
    ...
    @ServiceMethod(id = "center.deviceData.timeoutLog", pid = "center.deviceData", prefix = "打开", name = "超时驾驶日志",
            suffix = "页面")
    ...
    @ServiceMethod(id = "center.deviceData.parameterLog", pid = "center.deviceData", prefix = "打开", name = "参数修改日志",
            suffix = "页面")
    ...
    @ServiceMethod(id = "center.deviceData.loginLog", pid = "center.deviceData", prefix = "打开", name = "驾驶员登签日志",
            suffix = "页面")
    ...
    @ServiceMethod(id = "center.deviceData.speedStatusLog", pid = "center.deviceData", prefix = "打开", name = "速度状态",
            suffix = "页面")
    ...
    @ServiceMethod(id = "center.deviceData.locateLog", pid = "center.deviceData", prefix = "打开", name = "位置记录",
            suffix = "页面")
    ...
    @ServiceMethod(id = "center.deviceData.speedLog", pid = "center.deviceData", prefix = "打开", name = "速度记录", suffix
            = "页面")
