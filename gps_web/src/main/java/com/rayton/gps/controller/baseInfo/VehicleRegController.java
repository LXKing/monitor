...
public class VehicleRegController {
    ...
    @ResponseBody
    public ResponseEntity<Map<String, Object>> addSections(@RequestParam String driverId, @RequestParam String vr)
            throws Exception {
    ...
    @ResponseBody
    public ResponseEntity<Map<String, Object>> removeSection(@RequestParam String driverId, @RequestParam String vr)
            throws Exception {
        Assist a = new Assist();
