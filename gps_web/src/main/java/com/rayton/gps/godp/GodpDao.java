...
import com.rayton.gps.domain.drivingrecorder.SpeedStatusLog;
...
public class GodpDao implements IGodpDao {
    ...
    public List<FeatureDto> loadFeatures(String number) throws Exception {
        ...
        com.rayton.gps.dao.baseinfo.device.Device device = deviceDao.getByNum(number);


        request.setProtocol(Integer.parseInt(device.getProtocol().substring(2), 16));
        // if (number.equals("120187322661")) {
        //     request.setProtocol(ProtocolKinds.kangkaisi);
        // } else {
        //     request.setProtocol(ProtocolKinds.JTT808);
        // }
