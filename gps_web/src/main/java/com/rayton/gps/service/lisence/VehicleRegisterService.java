...
public interface VehicleRegisterService {
     ...
     * @return
     */
    VehicleRegister selectVehicleRegisterById(String id);
     ...
     * @return
     */
    int deleteVehicleRegisterById(String id);
     ...
     * @return
     */
    int updateVehicleRegister(VehicleRegister value, Assist assist);
     ...
     * @return
     */
    int updateNonEmptyVehicleRegister(VehicleRegister value, Assist assist);
}