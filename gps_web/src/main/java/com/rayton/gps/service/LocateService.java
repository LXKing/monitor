...
import com.rayton.gps.domain.gateway.MultimediaDataUploadReport;
import com.rayton.gps.domain.push.*;
import com.rayton.gps.domain.statistics.DeviceOnlineOfflineReport;
...
public class LocateService {
    ...
    public Object loadUnreadDeviceUpgradeResultReport(String userId) {
        ...
        result.forEach(upgradeResultReportDto -> {
