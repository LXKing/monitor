...
public class StupidRSA {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String inputStr = "888888";
        byte[] encodedData = StupidRSA.encryptByPublicKey(inputStr, publicKey);
        byte[] decodedData = StupidRSA.decryptByPrivateKey(encodedData, privateKey);
