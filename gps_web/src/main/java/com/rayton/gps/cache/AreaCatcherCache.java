...
import com.rayton.gps.dao.cache.area.*;
import com.rayton.gps.dao.locate.Latest;
import com.rayton.gps.service.AreaCatcherService;
...
public class AreaCatcherCache {
    ...
    //     // circles.forEach(areaInfo -> AreaCatcherCache.bind(areaInfo.getDeviceNumber(), areaInfo.getAreaId(),
    // areaInfo
    //     //         .getAreaType()));
