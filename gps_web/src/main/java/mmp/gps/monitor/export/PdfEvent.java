...
public class PdfEvent extends PdfPageEventHelper {
     ...
     */
    public PdfEvent(PdfWriter writer) {
     ...
     */
    public PdfEvent(String yeMei, int presentFontSize, Rectangle pageSize) {
        this.header = yeMei;
     ...
     * TODO 文档打开时创建模板
     *
     * @see com.itextpdf.text.pdf.PdfPageEventHelper#onOpenDocument(com.itextpdf.text.pdf.PdfWriter, * com.itextpdf
     * .text.Document)
     */
     ...
     *
     * @see com.itextpdf.text.pdf.PdfPageEventHelper#onEndPage(com.itextpdf.text.pdf.PdfWriter, * com.itextpdf.text
     * .Document)
     */
     ...
     *
     * @see com.itextpdf.text.pdf.PdfPageEventHelper#onCloseDocument(com.itextpdf.text.pdf.PdfWriter, * com.itextpdf
     * .text.Document)
     */
