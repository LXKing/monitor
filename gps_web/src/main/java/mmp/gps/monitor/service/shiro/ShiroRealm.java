package mmp.gps.monitor.service.shiro;
...
public class ShiroRealm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
        ...
        try {
            dto = securityService.get(account);
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        AuthenticationInfo simpleAuthenticationInfo = new SimpleAuthenticationInfo(dto, // principal
                ...
                ByteSource.Util.bytes(dto.getAccount()), // credentialsSalt
    ...
    protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
        ...
        IdentityDto user = (IdentityDto) principals.getPrimaryPrincipal();
