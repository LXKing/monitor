...
import mmp.gps.monitor.dao.IStatisticsDao;
...
import mmp.gps.monitor.dao.security.OperateLog;
import mmp.gps.monitor.dao.security.OperateLogDto;
import mmp.gps.domain.statistics.*;
import mmp.gps.domain.statistics.MileageOilCountResult;
...
public class StatisticsService {
    ...
    public List<HistoryOnlineOfflineCount> historyOnlineOfflineCount(String userId, String motorcade, Date start, Date end)
            throws Exception {
     ...
     * 统计历史上线下线率，根据车队汇总
     */
    public Page<HistoryOnlineOfflineCount> historyOnlineOfflineCount(String userId, String motorcade, Date start, Date end, int pageIndex, int pageSize)
            throws Exception {
     ...
     * 统计历史上线下线率，根据车辆明细
     */
    public Page<HistoryOnlineOfflineDetail> historyOnlineOfflineDetail(String userId, String motorcadeId, String motorcade, Date start, Date end, int pageIndex, int pageSize)
            throws Exception {
     ...
     * 历史在线时长明细
     */
    public Page<HistoryOnlineTimeDetail> historyOnlineTimeDetail(String userId, String motorcadeId, String motorcade, Date start, Date end, int pageIndex, int pageSize)
            throws Exception {
     ...
     * @throws Exception
     */
    public Page<CurrentOnlineOfflineCount> currentOnlineOfflineCount(String userId, String motorcade, int pageIndex, int pageSize)
            throws Exception {
     ...
     * @throws Exception
     */
    public List<CurrentOnlineOfflineDetail> currentOnlineOfflineDetail(String userId, String motorcadeId, String motorcade)
            throws Exception {
     ...
     * @throws Exception
     */
    public Object currentOnlineOfflineDetail(String userId, String motorcadeId, String motorcade, int pageIndex, int pageSize)
            throws Exception {
     ...
     * 统计里程及油耗
     */
    public List<MileageOilCount> mileageOilCount(String userId, String motorcade, Date start, Date end)
            throws Exception {
     ...
     * 统计里程及油耗
     */
    public Page<MileageOilCount> mileageOilCount(String userId, String motorcade, Date start, Date end, int pageIndex, int pageSize)
            throws Exception {
    ...
    public List<MileageOilDetail> mileageOilDetail(String userId, String motorcadeId, String motorcade, Date start, Date end)
            throws Exception {
    ...
    public List<VehicleAlarmCount> vehicleAlarmCount(String userId, String motorcade, Date start, Date end) {
        ...
        // 建立关系，以便从后台查到数据后更新
        Map<String, VehicleAlarmCount> links = new HashMap<>();
        ...
        for (MonitorTarget mo : allmotorcades) {
            ...
            allDevices.stream()
                    .filter(monitorTarget -> monitorTarget.getPid().equals(mo.getId()))
                    .forEach(monitorTarget -> {
    ...
    public List<VehicleAlarmDetail> vehicleAlarmDetail(String userId, String motorcadeId, String motorcade, Date start, Date end)
            throws Exception {
    ...
    public List<VehicleFatigueDrivingCount> vehicleFatigueDrivingCount(String userId, String motorcade, Date start, Date end)
            throws Exception {
    ...
    public Page<VehicleFatigueDrivingCount> vehicleFatigueDrivingCount(String userId, String motorcade, Date start, Date end, int pageIndex, int pageSize)
            throws Exception {
    ...
    public Page<VehicleFatigueDrivingDetail> vehicleFatigueDrivingDetail(String userId, String motorcadeId, String motorcade, Date start, Date end, int pageIndex, int pageSize)
            throws Exception {
    ...
    public List<VehicleOverspeedCount> vehicleOverspeedCount(String userId, String motorcade, Date start, Date end)
            throws Exception {
        List<VehicleOverspeedCount> rows = new ArrayList<>();
        // 获取用户监控对象
        List<MonitorTarget> allmotorcades = findMotorcade(userId, motorcade);
        if (allmotorcades.size() <= 0)
            return rows;
        ...
        for (String number : numbers) {
            ...
            List<OverS> times = statisticsServiceDao.vehicleOverspeeds(number, start, end);

            Date prev = null;
            for (OverS time : times) {
                dto.times += 1;
                if (prev == null) {
                    prev = time.getGPSTIME();
                    continue;
                }
                Date curr = time.getGPSTIME();
                long currTimes = curr.getTime();
                long prevTimes = prev.getTime();
                long mm = currTimes - prevTimes;
        ...
        for (VehicleOverspeedDto dto : list) {
            ...
            count.setDuration(count.getDuration() + dto.duration);
            count.setTimes(count.getTimes() + dto.times);
            count.setLAT(dto.LAT);
            count.setLNG(dto.LNG);
        }
        return rows;
    }
    ...
    public List<VehicleOverspeedDetail> vehicleOverspeedDetail(String userId, String motorcadeId, String motorcade, Date start, Date end)
        ...
        for (VehicleOverspeedDto dto : list) {
            ...
            detail.setDuration(dto.duration);
            detail.setTimes(dto.times);
            detail.setLAT(dto.LAT);
            detail.setLNG(dto.LNG);
        }
        return rows;
    }

    public Page<VehicleOverspeedDetail> vehicleOverspeedDetail(String userId, String motorcadeId, String motorcade, Date start, Date end, int pageIndex, int pageSize)
            throws Exception {
        ...
        if (motorcadeDevices.size() > startIndex) {
            ...
            for (int index = startIndex; index < motorcadeDevices.size(); index++) {
                ...
                Vehicle vehicle = vehicleDao.getWhat(mt.getDeviceNumber());
    ...
    public Page<SectionOverspeedDetail> sectionOverspeedDetail(String userId, String motorcadeId, String motorcade, Date start, Date end, int pageIndex, int pageSize)
            throws Exception {
    ...
    public List<AreaOverspeedCount> areaOverspeedCount(String userId, String motorcade, Date start, Date end)
            throws Exception {
    ...
    public List<AreaOverspeedDetail> areaOverspeedDetail(String userId, String motorcadeId, String motorcade, Date start, Date end)
            throws Exception {
    ...
    public Page<AreaOverspeedDetail> areaOverspeedDetail(String userId, String motorcadeId, String motorcade, Date start, Date end, int pageIndex, int pageSize)
            throws Exception {
    ...
    public Page<TimeoutParkingDetail> timeoutParkingDetail(String userId, String motorcadeId, String motorcade, Date start, Date end, int pageIndex, int pageSize)
            throws Exception {
    ...
    public Page<AreaIoCount> areaIoCount(String userId, String motorcade, Date start, Date end, int pageIndex, int pageSize)
            throws Exception {
