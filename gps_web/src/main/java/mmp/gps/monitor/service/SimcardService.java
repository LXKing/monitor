...
public class SimcardService {
    ...
    public void create(Simcard simcard) throws Exception {
        ...
        simcard.setPhoneNumber(simcard.getIccid());
    ...
    public List<Simcard> selectSIMcard(String companyId) throws Exception {
        List<Simcard> rows = simcardDao.selectSIMcard(companyId);
        return rows;
    }
