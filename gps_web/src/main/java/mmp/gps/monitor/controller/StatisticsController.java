...
import mmp.gps.monitor.export.ExcelView;
import mmp.gps.monitor.export.PdfView;
import mmp.gps.monitor.model.baseinfo.AdminMenu;
import mmp.gps.monitor.service.SecurityService;
import mmp.gps.monitor.service.StatisticsService;
...
public class StatisticsController {
    ...
    public Object menus() throws Exception {
        ...
        if (securityService.hasAuthorized("statistics.historyOnlineOffline", list, roles, user)) {
        ...
        if (securityService.hasAuthorized("statistics.historyOnlineTime", list, roles, user)) {
        ...
        if (securityService.hasAuthorized("statistics.currentOnlineOffline", list, roles, user)) {
        ...
        if (securityService.hasAuthorized("statistics.mileageOil", list, roles, user)) {
        ...
        if (securityService.hasAuthorized("statistics.vehicleAlarm", list, roles, user)) {
        ...
        if (securityService.hasAuthorized("statistics.vehicleFatigueDriving", list, roles, user)) {
        ...
        if (securityService.hasAuthorized("statistics.routeDeviation", list, roles, user)) {
        ...
        if (securityService.hasAuthorized("statistics.areaIo", list, roles, user)) {
        ...
        if (securityService.hasAuthorized("statistics.operateLog", list, roles, user)) {
    ...
    @ResponseBody
    public Object historyOnlineOfflineCount(@RequestParam String motorcade, @RequestParam Date start, @RequestParam Date end, @RequestParam int pageIndex, @RequestParam int pageSize)
            throws Exception {
        IdentityDto identity = (IdentityDto) SecurityUtils.getSubject().getPrincipals().getPrimaryPrincipal();
    ...
    public ModelAndView historyOnlineOfflineCountExport(@RequestParam String motorcade, @RequestParam Date start, @RequestParam Date end, @RequestParam String type, HttpServletRequest request, HttpServletResponse response)
            throws Exception {
        IdentityDto identity = (IdentityDto) SecurityUtils.getSubject().getPrincipals().getPrimaryPrincipal();
    ...
    @ResponseBody
    public Object historyOnlineOfflineDetail(@RequestParam String motorcadeId, @RequestParam String motorcade, @RequestParam Date start, @RequestParam Date end, @RequestParam int pageIndex, @RequestParam int pageSize, HttpServletRequest request)
            throws Exception {
        IdentityDto identity = (IdentityDto) SecurityUtils.getSubject().getPrincipals().getPrimaryPrincipal();
    ...
    public ModelAndView historyOnlineOfflineDetailExport(@RequestParam String motorcadeId, @RequestParam String motorcade, @RequestParam Date start, @RequestParam Date end, @RequestParam String type, HttpServletRequest request)
            throws Exception {
        IdentityDto identity = (IdentityDto) SecurityUtils.getSubject().getPrincipals().getPrimaryPrincipal();
    ...
    @ResponseBody
    public Object historyOnlineTimeCount(@RequestParam String motorcade, @RequestParam Date start, @RequestParam Date end, @RequestParam int pageIndex, @RequestParam int pageSize)
            throws Exception {
        IdentityDto identity = (IdentityDto) SecurityUtils.getSubject().getPrincipals().getPrimaryPrincipal();
    ...
    public ModelAndView historyOnlineTimeCountExport(@RequestParam String motorcade, @RequestParam Date start, @RequestParam Date end, @RequestParam String type, HttpServletRequest request)
            throws Exception {
        IdentityDto identity = (IdentityDto) SecurityUtils.getSubject().getPrincipals().getPrimaryPrincipal();
    ...
    @ResponseBody
    public Object historyOnlineTimeDetail(@RequestParam String motorcadeId, @RequestParam String motorcade, @RequestParam Date start, @RequestParam Date end, @RequestParam int pageIndex, @RequestParam int pageSize, HttpServletRequest request)
            throws Exception {
        IdentityDto identity = (IdentityDto) SecurityUtils.getSubject().getPrincipals().getPrimaryPrincipal();
    ...
    public ModelAndView historyOnlineTimeDetailExport(@RequestParam String motorcadeId, @RequestParam String motorcade, @RequestParam Date start, @RequestParam Date end, @RequestParam String type, HttpServletRequest request)
            throws Exception {
        IdentityDto identity = (IdentityDto) SecurityUtils.getSubject().getPrincipals().getPrimaryPrincipal();
    ...
    @ResponseBody
    public Object currentOnlineOfflineDetail(@RequestParam String motorcadeId, @RequestParam String motorcade, @RequestParam int pageIndex, @RequestParam int pageSize, HttpServletRequest request)
            throws Exception {
        IdentityDto identity = (IdentityDto) SecurityUtils.getSubject().getPrincipals().getPrimaryPrincipal();
    ...
    @ResponseBody
    public Object mileageOilCount(@RequestParam String motorcade, @RequestParam int pageIndex, @RequestParam int pageSize, @RequestParam Date start, @RequestParam Date end)
            throws Exception {
        IdentityDto identity = (IdentityDto) SecurityUtils.getSubject().getPrincipals().getPrimaryPrincipal();
    ...
    public ModelAndView mileageOilCountExport(@RequestParam String motorcade, @RequestParam Date start, @RequestParam Date end, @RequestParam String type)
            throws Exception {
        IdentityDto identity = (IdentityDto) SecurityUtils.getSubject().getPrincipals().getPrimaryPrincipal();
    ...
    @ResponseBody
    public Object mileageOilDetail(@RequestParam String motorcadeId, @RequestParam String motorcade, @RequestParam Date start, @RequestParam Date end, @RequestParam int pageIndex, @RequestParam int pageSize, HttpServletRequest request)
            throws Exception {
        IdentityDto identity = (IdentityDto) SecurityUtils.getSubject().getPrincipals().getPrimaryPrincipal();
    ...
    public ModelAndView mileageOilDetailExport(@RequestParam String motorcadeId, @RequestParam String motorcade, @RequestParam Date start, @RequestParam Date end, @RequestParam String type)
            throws Exception {
        IdentityDto identity = (IdentityDto) SecurityUtils.getSubject().getPrincipals().getPrimaryPrincipal();
    ...
    @ResponseBody
    public Object vehicleAlarmCount(@RequestParam String motorcade, @RequestParam int pageIndex, @RequestParam int pageSize, @RequestParam Date start, @RequestParam Date end)
            throws Exception {
        IdentityDto identity = (IdentityDto) SecurityUtils.getSubject().getPrincipals().getPrimaryPrincipal();
    ...
    public ModelAndView vehicleAlarmCountExport(@RequestParam String motorcade, @RequestParam Date start, @RequestParam Date end, @RequestParam String type, HttpServletRequest request)
            throws Exception {
        IdentityDto identity = (IdentityDto) SecurityUtils.getSubject().getPrincipals().getPrimaryPrincipal();
    ...
    @ResponseBody
    public Object vehicleAlarmDetail(@RequestParam String motorcadeId, @RequestParam String motorcade, @RequestParam Date start, @RequestParam Date end, @RequestParam int pageIndex, @RequestParam int pageSize, HttpServletRequest request)
            throws Exception {
        IdentityDto identity = (IdentityDto) SecurityUtils.getSubject().getPrincipals().getPrimaryPrincipal();
    ...
    public ModelAndView vehicleAlarmDetailExport(@RequestParam String motorcadeId, @RequestParam String motorcade, @RequestParam Date start, @RequestParam Date end, @RequestParam String type)
            throws Exception {
        IdentityDto identity = (IdentityDto) SecurityUtils.getSubject().getPrincipals().getPrimaryPrincipal();
    ...
    @ResponseBody
    public Object vehicleFatigueDrivingCount(@RequestParam String motorcade, @RequestParam int pageIndex, @RequestParam int pageSize, @RequestParam Date start, @RequestParam Date end)
            throws Exception {
        IdentityDto identity = (IdentityDto) SecurityUtils.getSubject().getPrincipals().getPrimaryPrincipal();
    ...
    public ModelAndView vehicleFatigueDrivingCountExport(@RequestParam String motorcade, @RequestParam Date start, @RequestParam Date end, @RequestParam String type, HttpServletRequest request)
            throws Exception {
        IdentityDto identity = (IdentityDto) SecurityUtils.getSubject().getPrincipals().getPrimaryPrincipal();
    ...
    @ResponseBody
    public Object vehicleFatigueDrivingDetail(@RequestParam String motorcadeId, @RequestParam String motorcade, @RequestParam Date start, @RequestParam Date end, @RequestParam int pageIndex, @RequestParam int pageSize, HttpServletRequest request)
            throws Exception {
        IdentityDto identity = (IdentityDto) SecurityUtils.getSubject().getPrincipals().getPrimaryPrincipal();
    ...
    public ModelAndView vehicleFatigueDrivingDetailExport(@RequestParam String motorcadeId, @RequestParam String motorcade, @RequestParam Date start, @RequestParam Date end, @RequestParam String type, HttpServletRequest request)
            throws Exception {
        IdentityDto identity = (IdentityDto) SecurityUtils.getSubject().getPrincipals().getPrimaryPrincipal();
    ...
    @ResponseBody
    public Object vehicleOverspeedCount(@RequestParam String motorcade, @RequestParam int pageIndex, @RequestParam int pageSize, @RequestParam Date start, @RequestParam Date end)
            throws Exception {
        IdentityDto identity = (IdentityDto) SecurityUtils.getSubject().getPrincipals().getPrimaryPrincipal();
    ...
    public ModelAndView vehicleOverspeedCountExport(@RequestParam String motorcade, @RequestParam Date start, @RequestParam Date end, @RequestParam String type, HttpServletRequest request)
            throws Exception {
        IdentityDto identity = (IdentityDto) SecurityUtils.getSubject().getPrincipals().getPrimaryPrincipal();
    ...
    @ResponseBody
    public Object vehicleOverspeedDetail(@RequestParam String motorcadeId, @RequestParam String motorcade, @RequestParam Date start, @RequestParam Date end, @RequestParam int pageIndex, @RequestParam int pageSize, HttpServletRequest request)
            throws Exception {
        IdentityDto identity = (IdentityDto) SecurityUtils.getSubject().getPrincipals().getPrimaryPrincipal();
        Page<VehicleOverspeedDetail> res = statisticsService.vehicleOverspeedDetail(identity.getId(), motorcadeId, motorcade, start, end, pageIndex, pageSize);
        return res;
    }

    @PostMapping(value = "/statistics/vehicleOverspeedDetailExport")
    public ModelAndView vehicleOverspeedDetailExport(@RequestParam String motorcadeId, @RequestParam String motorcade, @RequestParam Date start, @RequestParam Date end, @RequestParam String type, HttpServletRequest request)
            throws Exception {
        IdentityDto identity = (IdentityDto) SecurityUtils.getSubject().getPrincipals().getPrimaryPrincipal();
    ...
    @ResponseBody
    public Object sectionOverspeedCount(@RequestParam String motorcade, @RequestParam int pageIndex, @RequestParam int pageSize, @RequestParam Date start, @RequestParam Date end)
            throws Exception {
        IdentityDto identity = (IdentityDto) SecurityUtils.getSubject().getPrincipals().getPrimaryPrincipal();
    ...
    public ModelAndView sectionOverspeedCountExport(@RequestParam String motorcade, @RequestParam Date start, @RequestParam Date end, @RequestParam String type, HttpServletRequest request)
            throws Exception {
        IdentityDto identity = (IdentityDto) SecurityUtils.getSubject().getPrincipals().getPrimaryPrincipal();
    ...
    @ResponseBody
    public Object sectionOverspeedDetail(@RequestParam String motorcadeId, @RequestParam String motorcade, @RequestParam Date start, @RequestParam Date end, @RequestParam int pageIndex, @RequestParam int pageSize, HttpServletRequest request)
            throws Exception {
        IdentityDto identity = (IdentityDto) SecurityUtils.getSubject().getPrincipals().getPrimaryPrincipal();
    ...
    public ModelAndView sectionOverspeedDetailExport(@RequestParam String motorcadeId, @RequestParam String motorcade, @RequestParam Date start, @RequestParam Date end, @RequestParam String type, HttpServletRequest request)
            throws Exception {
        IdentityDto identity = (IdentityDto) SecurityUtils.getSubject().getPrincipals().getPrimaryPrincipal();
    ...
    @ResponseBody
    public Object areaOverspeedCount(@RequestParam String motorcade, @RequestParam int pageIndex, @RequestParam int pageSize, @RequestParam Date start, @RequestParam Date end)
            throws Exception {
        IdentityDto identity = (IdentityDto) SecurityUtils.getSubject().getPrincipals().getPrimaryPrincipal();
    ...
    public ModelAndView areaOverspeedCountExport(@RequestParam String motorcade, @RequestParam Date start, @RequestParam Date end, @RequestParam String type)
            throws Exception {
        IdentityDto identity = (IdentityDto) SecurityUtils.getSubject().getPrincipals().getPrimaryPrincipal();
    ...
    @ResponseBody
    public Object areaOverspeedDetail(@RequestParam String motorcadeId, @RequestParam String motorcade, @RequestParam Date start, @RequestParam Date end, @RequestParam int pageIndex, @RequestParam int pageSize, HttpServletRequest request)
            throws Exception {
        IdentityDto identity = (IdentityDto) SecurityUtils.getSubject().getPrincipals().getPrimaryPrincipal();
    ...
    public ModelAndView areaOverspeedDetailExport(@RequestParam String motorcadeId, @RequestParam String motorcade, @RequestParam Date start, @RequestParam Date end, @RequestParam String type)
            throws Exception {
        IdentityDto identity = (IdentityDto) SecurityUtils.getSubject().getPrincipals().getPrimaryPrincipal();
    ...
    @ResponseBody
    public Object timeoutParkingCount(@RequestParam String motorcade, @RequestParam int pageIndex, @RequestParam int pageSize, @RequestParam Date start, @RequestParam Date end)
            throws Exception {
        IdentityDto identity = (IdentityDto) SecurityUtils.getSubject().getPrincipals().getPrimaryPrincipal();
    ...
    public ModelAndView timeoutParkingCountExport(@RequestParam String motorcade, @RequestParam Date start, @RequestParam Date end, @RequestParam String type, HttpServletRequest request)
            throws Exception {
        IdentityDto identity = (IdentityDto) SecurityUtils.getSubject().getPrincipals().getPrimaryPrincipal();
    ...
    @ResponseBody
    public Object timeoutParkingDetail(@RequestParam String motorcadeId, @RequestParam String motorcade, @RequestParam Date start, @RequestParam Date end, @RequestParam int pageIndex, @RequestParam int pageSize)
            throws Exception {
        IdentityDto identity = (IdentityDto) SecurityUtils.getSubject().getPrincipals().getPrimaryPrincipal();
    ...
    public ModelAndView timeoutParkingDetailExport(@RequestParam String motorcadeId, @RequestParam String motorcade, @RequestParam Date start, @RequestParam Date end, @RequestParam String type)
            throws Exception {
        IdentityDto identity = (IdentityDto) SecurityUtils.getSubject().getPrincipals().getPrimaryPrincipal();
    ...
    @ResponseBody
    public Object routeDeviationCount(@RequestParam String motorcade, @RequestParam int pageIndex, @RequestParam int pageSize, @RequestParam Date start, @RequestParam Date end)
            throws Exception {
        IdentityDto identity = (IdentityDto) SecurityUtils.getSubject().getPrincipals().getPrimaryPrincipal();
    ...
    public ModelAndView routeDeviationCountExport(@RequestParam String motorcade, @RequestParam Date start, @RequestParam Date end, @RequestParam String type)
            throws Exception {
        IdentityDto identity = (IdentityDto) SecurityUtils.getSubject().getPrincipals().getPrimaryPrincipal();
    ...
    @ResponseBody
    public Object routeDeviationDetail(@RequestParam String motorcadeId, @RequestParam String motorcade, @RequestParam Date start, @RequestParam Date end, @RequestParam int pageIndex, @RequestParam int pageSize)
            throws Exception {
        IdentityDto identity = (IdentityDto) SecurityUtils.getSubject().getPrincipals().getPrimaryPrincipal();
    ...
    public ModelAndView routeDeviationDetailExport(@RequestParam String motorcadeId, @RequestParam String motorcade, @RequestParam Date start, @RequestParam Date end, @RequestParam String type)
            throws Exception {
        IdentityDto identity = (IdentityDto) SecurityUtils.getSubject().getPrincipals().getPrimaryPrincipal();
    ...
    @ResponseBody
    public Object areaIoCount(@RequestParam String motorcade, @RequestParam int pageIndex, @RequestParam int pageSize, @RequestParam Date start, @RequestParam Date end)
            throws Exception {
        IdentityDto identity = (IdentityDto) SecurityUtils.getSubject().getPrincipals().getPrimaryPrincipal();
    ...
    public ModelAndView areaIoCountExport(@RequestParam String motorcade, @RequestParam Date start, @RequestParam Date end, @RequestParam String type)
            throws Exception {
        IdentityDto identity = (IdentityDto) SecurityUtils.getSubject().getPrincipals().getPrimaryPrincipal();
    ...
    @ResponseBody
    public Object areaIoDetail(@RequestParam String motorcadeId, @RequestParam String motorcade, @RequestParam Date start, @RequestParam Date end, @RequestParam int pageIndex, @RequestParam int pageSize, HttpServletRequest request)
            throws Exception {
        IdentityDto identity = (IdentityDto) SecurityUtils.getSubject().getPrincipals().getPrimaryPrincipal();
    ...
    public ModelAndView areaIoDetailExport(@RequestParam String motorcadeId, @RequestParam String motorcade, @RequestParam Date start, @RequestParam Date end, @RequestParam String type)
            throws Exception {
        IdentityDto identity = (IdentityDto) SecurityUtils.getSubject().getPrincipals().getPrimaryPrincipal();
    ...
    @ResponseBody
    public Object operateLog(@RequestParam String user, @RequestParam int pageIndex, @RequestParam int pageSize, @RequestParam Date start, @RequestParam Date end)
            throws Exception {
        IdentityDto identity = (IdentityDto) SecurityUtils.getSubject().getPrincipals().getPrimaryPrincipal();
