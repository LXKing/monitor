var renderVehicle = function (url) {
	...
	<div class="layui-form-item layui-inline pane">
		...
		<div class="layui-input-block">
			<input type="number" name="initialMileage" id="initialMileage" placeholder="请输入" autocomplete="off" class="layui-input">
		</div>
	</div>
	<div class="layui-form-item layui-inline pane">
		<label class="layui-form-label">百公里油耗</label>
		<div class="layui-input-block">
			<input type="number" name="oilWear" id="oilWear" placeholder="请输入" autocomplete="off" class="layui-input">
		</div>
	</div>
	<div class="layui-form-item layui-inline pane">
		<label class="layui-form-label">使用年限</label>
		<div class="layui-input-block">
			<input type="number" name="usefulLife" id="usefulLife" placeholder="请输入" autocomplete="off" class="layui-input">
		</div>
	</div>
	<div class="layui-form-item layui-inline pane">
	...
	<div class="layui-form-item layui-inline pane">
		...
		<div class="layui-input-block">
			<input type="text" name="annualSurveyDate" id="annualSurveyDate" placeholder="请输入" autocomplete="off" class="layui-input">
		</div>
	</div>
	<div class="layui-form-item layui-inline pane">
