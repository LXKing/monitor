var Ren_timeoutParkingCount = function (url) {
    ...
    table.render({
        ...
        cols: [
            [
                ...
                {field: 'duration', title: '停车时长', sort: true},

                {field: 'times', title: '停车次数', sort: true},
        ...
        if (obj.event === 'more') {
            ...
            var jjj = layer.open({
                ...
                , yes: function () {
                    ...
                    jQuery.ajax({
                        url: '/statistics/timeoutParkingCountExport',
                        type: "POST",
                        data: params,
                        success: function (response, status, request) {
                            var url='/statistics/timeoutParkingCountExport';
                ...
                success: function (layero, index) {
                    ...
                    table.render({
                        elem: '#detail'
                        , url: '/statistics/timeoutParkingDetail', //数据接口
                        page: true, // 开启分页
                        method: "POST",
                        where: {
                            motorcade: data.motorcade,
