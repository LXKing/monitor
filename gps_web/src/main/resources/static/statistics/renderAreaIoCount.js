var Ren_areaIoCount = function (url) {
    ...
    table.render({
        ...
        cols: [
            [
                ...
                {field: 'out', title: '出区域次数', sort: true},

                {field: 'in', title: '进区域次数', sort: true},
        ...
        if (obj.event === 'more') {
            ...
            var jjj = layer.open({
                ...
                , yes: function () {
                    ...
                    jQuery.ajax({
                        url: '/statistics/areaIoCountExport',
                        type: "POST",
                        data: params,
                        success: function (response, status, request) {
                            var url='/statistics/areaIoCountExport';
                ...
                success: function (layero, index) {
                    ...
                    table.render({
                        elem: '#detail'
                        , url: '/statistics/areaIoDetail', //数据接口
                        page: true, // 开启分页
                        method: "POST",
                        where: {
                            motorcade: data.motorcade,
