var Ren_vehicleFatigueDrivingCount = function (url) {
    ...
    table.render({
        ...
        cols: [
            [
                ...
                {field: 'duration', title: '疲劳时长', sort: true},
                {field: 'mileages', title: '疲劳合计里程', sort: true},
                {field: 'times', title: '疲劳驾驶次数', sort: true},
        ...
        if (obj.event === 'more') {
            ...
            var jjj = layer.open({
                ...
                , yes: function () {
                    ...
                    jQuery.ajax({
                        url: '/statistics/vehicleFatigueDrivingCountExport',
                        type: "POST",
                        data: params,
                        success: function (response, status, request) {
                            var url='/statistics/vehicleFatigueDrivingCountExport';
                ...
                success: function (layero, index) {
                    ...
                    table.render({
                        elem: '#detail'
                        , url: '/statistics/vehicleFatigueDrivingDetail', //数据接口
                        page: true, // 开启分页
                        method: "POST",
                        where: {
                            motorcade: data.motorcade,
