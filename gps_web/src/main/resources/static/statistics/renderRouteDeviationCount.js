var Ren_routeDeviationCount = function (url) {
    ...
    table.render({
        ...
        cols: [
            [
                ...
                {field: 'duration', title: '偏离时长', sort: true},

                {field: 'times', title: '偏离次数', sort: true},
        ...
        if (obj.event === 'more') {
            ...
            var jjj = layer.open({
                ...
                , yes: function () {
                    ...
                    jQuery.ajax({
                        url: '/statistics/routeDeviationCountExport',
                        type: "POST",
                        data: params,
                        success: function (response, status, request) {
                            var url='/statistics/routeDeviationCountExport';
                ...
                success: function (layero, index) {
                    ...
                    table.render({
                        elem: '#detail'
                        , url: '/statistics/routeDeviationDetail', //数据接口
                        page: true, // 开启分页
                        method: "POST",
                        where: {
                            motorcade: data.motorcade,
