var Ren_mileageOilCount = function (url) {
    ...
    table.render({
        ...
        cols: [
            [
                ...
                {field: 'mileages', title: '行驶里程(KM)', sort: true},
                {field: 'oils', title: '车辆油耗(L)', sort: true},
                {field: 'start', title: '开始时间', sort: true},
                {field: 'vehicles', title: '车辆总数', sort: true},
        ...
        if (obj.event === 'more') {
            ...
            var jjj = layer.open({
                ...
                , yes: function () {
                    ...
                    jQuery.ajax({
                        url: '/statistics/mileageOilCountExport',
                        type: "POST",
                        data: params,
                        success: function (response, status, request) {
                            var url='/statistics/mileageOilCountExport';
                ...
                success: function (layero, index) {
                    ...
                    table.render({
                        elem: '#detail'
                        , url: '/statistics/mileageOilDetail', //数据接口
                        page: true, // 开启分页
                        method: "POST",
                        where: {
                            motorcade: data.motorcade,
