...
window.replay={
    ...
    downloadCompleted: function () {
        ...
        function parseTrip(index,trip) {
            ...
            var newRow = [];
//这个开始
            newRow.push(' <li style="border-bottom: 1px dashed #666">');
            newRow.push(' <div class="stTime">' + trip.timeStart.toDate().toDateTimeString("hh:mm:ss") + '</div>');
            newRow.push(' <div class="stAdd"><span name="from"></span></div>');
            newRow.push('   <div class="edTime">'+trip.timeEnd.toDate().toDateTimeString("hh:mm:ss")+'</div>');
            ...
            newRow.push('   <td>速度</td>');
            newRow.push('   <td>最高速度</td>');
            newRow.push('    <td>油耗</td>');
            newRow.push('    <td>平均油耗</td>');
            newRow.push('   </thead>');
            newRow.push('    <tbody>');
            newRow.push('   <tr>');
            ...
            newRow.push('     <td>' + trip.averageOil + '(L/100km)</td>');
            newRow.push('   <tr>');
            newRow.push('   </tbody>');
            newRow.push('   </table>');
            newRow.push('    </div>');
            ...
            newRow.push('        </div>');
            newRow.push('   <div class="drivingTime" style="display: none;"> 行驶时长：' + trip.runtimes + '</div>');
            newRow.push(' </li>');
        ...
        function parsePark(trip) {
            ...
            newRow.push('		<span style="color:#c2c2c2;">停车:<span style="color:red;">' + trip.paktimes + '</span></span>');
            newRow.push('		<span style="color:#c2c2c2;">地点:<span name="address" style="color:#c2c2c2;"></span></span>');
            newRow.push('	</div>');
            newRow.push('</td>');
            newRow.push('</tr>');
            var row = $(newRow.join(''));
...
$(function() {
    ...
    $(".dl_info ul").delegate(".accelerate", "click", function(e) {
        ...
        if(replay.playAccelerate===600){
            ...
            replay.playAccelerate = replay.playAccelerate-100;
            if(replay.playAccelerate===900){

                $(this).parent().next().text("2X")
                $(this).parent().prev().children().attr('src',"./static/image/replay/click_qian.png");
            }else if(replay.playAccelerate===800){
                $(this).parent().next().text("3X")
            }else if(replay.playAccelerate===700){
                $(this).parent().next().text("4X")
            }else if(replay.playAccelerate===600){
                $(this).parent().next().text("5X")
