...
public class LocationInformationInquiryReplyHandler implements ICommandHandler {
    ...
    private Object[] keys = new Object[]{Integer.valueOf(1280), Integer.valueOf(513)};
    ...
    public void process(RawData raw, byte[] data, BulkDataDto bulk) {
        ...
        JTT808Packet packet = new JTT808Packet(new LocationInformationInquiryReplyBody());
        ...
        LocationInformationInquiryReplyBody body = (LocationInformationInquiryReplyBody) packet.getBody();
        LocationInformationBaseInfo baseInfo = body.getBaseInfo();
        LocationInformationAddonInfo addonInfo = body.getAddonInfo();
