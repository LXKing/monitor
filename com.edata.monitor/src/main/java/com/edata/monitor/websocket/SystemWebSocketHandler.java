...
public class SystemWebSocketHandler implements WebSocketHandler {
	...
	public void afterConnectionEstablished(WebSocketSession session) throws Exception {
		...
		Identify identify = (Identify) session.getAttributes().get("user");
		String userId = identify.getId();
		logger.debug(identify.getAccount() + ":" + session.getRemoteAddress().toString() + " connect to the websocket success......");
	...
	public void handleMessage(WebSocketSession session, WebSocketMessage<?> message) throws Exception {
		Identify identify = (Identify) session.getAttributes().get("user");
		logger.debug(identify.getAccount() + ":" + session.getRemoteAddress().toString() + message.toString());
	}
	...
	public void handleTransportError(WebSocketSession session, Throwable exception) throws Exception {
		...
		logger.debug(identify.getAccount() + ":" + session.getRemoteAddress().toString() + " websocket connection closed......");
