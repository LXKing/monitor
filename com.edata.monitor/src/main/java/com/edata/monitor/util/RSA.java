...
public class RSA {
     ...
     */
    public synchronized static String encrypt(String message) throws IllegalBlockSizeException, BadPaddingException,
     ...
     * @throws UnsupportedEncodingException
     */
    public synchronized static String decrypt(String message) throws IllegalBlockSizeException, BadPaddingException,
            UnsupportedEncodingException {
