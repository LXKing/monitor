...
import com.edata.monitor.dao.statistics.AreaIoDto;
import com.edata.monitor.dao.statistics.AreaOverspeedDto;
import com.edata.monitor.dao.statistics.AreaOverspeedRecord;
import com.edata.monitor.dao.statistics.IStatisticsDao;
import com.edata.monitor.dao.statistics.RouteDeviationDto;
import com.edata.monitor.dao.statistics.SectionOverspeedDto;
import com.edata.monitor.dao.statistics.TimeMileageRecord;
import com.edata.monitor.dao.statistics.TimeNameRecord;
import com.edata.monitor.dao.statistics.TimeoutParkingDto;
import com.edata.monitor.dao.statistics.VehicleAlarmDto;
import com.edata.monitor.dao.statistics.VehicleFatigueDrivingDto;
import com.edata.monitor.dao.statistics.VehicleOverspeedDto;
...
public class StatisticsService {
	...
	public List<HistoryOnlineOfflineCount> historyOnlineOfflineCount(String userId, String motorcade, Date start, Date end) throws Exception {
	 ...
	 * 统计历史上线下线率，根据车队汇总
	 */
	public Page<HistoryOnlineOfflineCount> historyOnlineOfflineCount(String userId, String motorcade, Date start, Date end, int pageIndex,
	 ...
	 * 统计历史上线下线率，根据车辆明细
	 */
	public List<HistoryOnlineOfflineDetail> historyOnlineOfflineDetail(String userId, String motorcadeId, String motorcade, Date start, Date end)
			throws Exception {
	 ...
	 * 统计历史上线下线率，根据车辆明细
	 */
	public Page<HistoryOnlineOfflineDetail> historyOnlineOfflineDetail(String userId, String motorcadeId, String motorcade, Date start, Date end,
	 ...
	 * 历史在线时长统计
	 */
	public List<HistoryOnlineTimeCount> historyOnlineTimeCount(String userId, String motorcade, Date start, Date end) throws Exception {
	 ...
	 * 历史在线时长统计
	 */
	public Page<HistoryOnlineTimeCount> historyOnlineTimeCount(String userId, String motorcade, Date start, Date end, int pageIndex, int pageSize)
			throws Exception {
	 ...
	 * 历史在线时长明细
	 */
	public List<HistoryOnlineTimeDetail> historyOnlineTimeDetail(String userId, String motorcadeId, String motorcade, Date start, Date end)
			throws Exception {
	 ...
	 * 历史在线时长明细
	 */
	public Page<HistoryOnlineTimeDetail> historyOnlineTimeDetail(String userId, String motorcadeId, String motorcade, Date start, Date end,
			int pageIndex, int pageSize) throws Exception {
	 ...
	 * @throws Exception
	 */
	public Page<CurrentOnlineOfflineCount> currentOnlineOfflineCount(String userId, String motorcade, int pageIndex, int pageSize) throws Exception {
	 ...
	 * @throws Exception
	 */
	public List<CurrentOnlineOfflineDetail> currentOnlineOfflineDetail(String userId, String motorcadeId, String motorcade) throws Exception {
	 ...
	 * @throws Exception
	 */
	public Object currentOnlineOfflineDetail(String userId, String motorcadeId, String motorcade, int pageIndex, int pageSize) throws Exception {
	 ...
	 * 统计里程及油耗
	 */
	public List<MileageOilCount> mileageOilCount(String userId, String motorcade, Date start, Date end) throws Exception {
	 ...
	 * 统计里程及油耗
	 */
	public Page<MileageOilCount> mileageOilCount(String userId, String motorcade, Date start, Date end, int pageIndex, int pageSize) throws Exception {
	...
	public List<MileageOilDetail> mileageOilDetail(String userId, String motorcadeId, String motorcade, Date start, Date end) throws Exception {
	...
	public Object mileageOilDetail(String userId, String motorcadeId, String motorcade, Date start, Date end, int pageIndex, int pageSize)
			throws Exception {
	...
	public Page<OperateLog> operateLog(String companyId, String user, Date start, Date end, int pageIndex, int pageSize) {
		int total = statisticsServiceDao.operateLogPageCount(companyId, user, start, end);
		Page<OperateLog> query = new Page<OperateLog>();
		query.total = total;

		if (total > 0) {
			List<OperateLogDto> rows = statisticsServiceDao.operateLogPageDetail(companyId, user, start, end, (pageIndex - 1) * pageSize, pageSize);
	...
	public Page<VehicleAlarmCount> vehicleAlarmCount(String userId, String motorcade, Date start, Date end, int pageIndex, int pageSize) {
	...
	public List<VehicleAlarmDetail> vehicleAlarmDetail(String userId, String motorcadeId, String motorcade, Date start, Date end) throws Exception {
	...
	public Object vehicleAlarmDetail(String userId, String motorcadeId, String motorcade, Date start, Date end, int pageIndex, int pageSize)
			throws Exception {
	...
	public List<VehicleFatigueDrivingCount> vehicleFatigueDrivingCount(String userId, String motorcade, Date start, Date end) throws Exception {
	...
	public Page<VehicleFatigueDrivingCount> vehicleFatigueDrivingCount(String userId, String motorcade, Date start, Date end, int pageIndex,
			int pageSize) throws Exception {
	...
	public List<VehicleFatigueDrivingDetail> vehicleFatigueDrivingDetail(String userId, String motorcadeId, String motorcade, Date start, Date end)
			throws Exception {
	...
	public Page<VehicleFatigueDrivingDetail> vehicleFatigueDrivingDetail(String userId, String motorcadeId, String motorcade, Date start, Date end,
			int pageIndex, int pageSize) throws Exception {
	...
	public List<VehicleOverspeedCount> vehicleOverspeedCount(String userId, String motorcade, Date start, Date end) throws Exception {
	...
	public Page<VehicleOverspeedCount> vehicleOverspeedCount(String userId, String motorcade, Date start, Date end, int pageIndex, int pageSize)
			throws Exception {
	...
	public List<VehicleOverspeedDetail> vehicleOverspeedDetail(String userId, String motorcadeId, String motorcade, Date start, Date end)
			throws Exception {
	...
	public Page<VehicleOverspeedDetail> vehicleOverspeedDetail(String userId, String motorcadeId, String motorcade, Date start, Date end,
			int pageIndex, int pageSize) throws Exception {
	...
	public List<SectionOverspeedCount> sectionOverspeedCount(String userId, String motorcade, Date start, Date end) throws Exception {
	...
	public Page<SectionOverspeedCount> sectionOverspeedCount(String userId, String motorcade, Date start, Date end, int pageIndex, int pageSize)
			throws Exception {
	...
	public List<SectionOverspeedDetail> sectionOverspeedDetail(String userId, String motorcadeId, String motorcade, Date start, Date end)
			throws Exception {
	...
	public Page<SectionOverspeedDetail> sectionOverspeedDetail(String userId, String motorcadeId, String motorcade, Date start, Date end,
			int pageIndex, int pageSize) throws Exception {
	...
	public List<AreaOverspeedCount> areaOverspeedCount(String userId, String motorcade, Date start, Date end) throws Exception {
	...
	public Page<AreaOverspeedCount> areaOverspeedCount(String userId, String motorcade, Date start, Date end, int pageIndex, int pageSize)
			throws Exception {
	...
	public List<AreaOverspeedDetail> areaOverspeedDetail(String userId, String motorcadeId, String motorcade, Date start, Date end) throws Exception {
	...
	public Page<AreaOverspeedDetail> areaOverspeedDetail(String userId, String motorcadeId, String motorcade, Date start, Date end, int pageIndex,
			int pageSize) throws Exception {
	...
	public List<TimeoutParkingCount> timeoutParkingCount(String userId, String motorcade, Date start, Date end) throws Exception {
	...
	public Page<TimeoutParkingCount> timeoutParkingCount(String userId, String motorcade, Date start, Date end, int pageIndex, int pageSize)
			throws Exception {
	...
	public List<TimeoutParkingDetail> timeoutParkingDetail(String userId, String motorcadeId, String motorcade, Date start, Date end)
			throws Exception {
	...
	public Page<TimeoutParkingDetail> timeoutParkingDetail(String userId, String motorcadeId, String motorcade, Date start, Date end, int pageIndex,
			int pageSize) throws Exception {
	...
	public List<RouteDeviationCount> routeDeviationCount(String userId, String motorcade, Date start, Date end) throws Exception {
	...
	public Page<RouteDeviationCount> routeDeviationCount(String userId, String motorcade, Date start, Date end, int pageIndex, int pageSize)
			throws Exception {
	...
	public List<RouteDeviationDetail> routeDeviationDetail(String userId, String motorcadeId, String motorcade, Date start, Date end)
			throws Exception {
	...
	public Object routeDeviationDetail(String userId, String motorcadeId, String motorcade, Date start, Date end, int pageIndex, int pageSize)
			throws Exception {
	...
	public Page<AreaIoCount> areaIoCount(String userId, String motorcade, Date start, Date end, int pageIndex, int pageSize) throws Exception {
	...
	public List<AreaIoDetail> areaIoDetail(String userId, String motorcadeId, String motorcade, Date start, Date end) throws Exception {
	...
	public Object areaIoDetail(String userId, String motorcadeId, String motorcade, Date start, Date end, int pageIndex, int pageSize)
			throws Exception {
