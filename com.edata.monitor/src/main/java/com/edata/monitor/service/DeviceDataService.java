...
import com.edata.monitor.dao.devicedata.IDeviceDataDao;
...
import com.edata.monitor.domain.devicedata.AccidentDoubtLog;
import com.edata.monitor.domain.devicedata.DrivingRecorderInfo;
import com.edata.monitor.domain.devicedata.LocateLog;
import com.edata.monitor.domain.devicedata.LoginLog;
import com.edata.monitor.domain.devicedata.MultimediaRetrieval;
import com.edata.monitor.domain.devicedata.ParameterLog;
import com.edata.monitor.domain.devicedata.PhotoInfo;
import com.edata.monitor.domain.devicedata.PowerLog;
import com.edata.monitor.domain.devicedata.SpeedLog;
import com.edata.monitor.domain.devicedata.SpeedStatusLog;
import com.edata.monitor.domain.devicedata.TimeoutLog;
...
import com.edata.monitor.util.kind.DrivingRecorderActions;
...
public class DeviceDataService {
	...
	public Page<MultimediaEventReport> queryMultimediaEventReport(String deviceNumber, Date start, Date end, int pageIndex, int pageSize) {
		...
		if (total > 0) {
			List<MultimediaEventReportDto> rows = deviceDataDao.queryMultimediaEventReportPageDetail(deviceNumber, start, end, (pageIndex - 1)
					* pageSize, pageSize);
	...
	public Page<MultimediaRetrieval> queryMultimediaDataRetrieval(String deviceNumber, Date start, Date end, int pageIndex, int pageSize) {
		...
		if (total > 0) {
			List<MultimediaRetrievalDto> rows = deviceDataDao.queryMultimediaDataRetrievalPageDetail(deviceNumber, start, end, (pageIndex - 1)
					* pageSize, pageSize);
	...
	public Object queryDeviceEventReport(String deviceNumber, Date start, Date end, int pageIndex, int pageSize) {
		...
		if (total > 0) {
			List<DeviceEventReportDto> rows = deviceDataDao.queryDeviceEventReportPageDetail(deviceNumber, start, end, (pageIndex - 1) * pageSize,
					pageSize);
	...
	public Object deviceUpgradeResultReport(String deviceNumber, Date start, Date end, int pageIndex, int pageSize) throws Exception {
		...
		if (total > 0) {
			List<UpgradeResultReportDto> rows = deviceDataDao.queryDeviceUpgradeResultReportPageDetail(deviceNumber, start, end, (pageIndex - 1)
					* pageSize, pageSize);
