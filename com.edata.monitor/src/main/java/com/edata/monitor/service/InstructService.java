...
public class InstructService {
	...
	public InstructInfo send(String userId, String serialNumber, String deviceNumber, String unid, String user, String command, String name,
			String params, String confirm) throws Exception {
