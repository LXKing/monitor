...
public class ExtHtmlTagRuleBundle implements TagRuleBundle {
	...
	public void install(State defaultState, ContentProperty contentProperty,
			SiteMeshContext siteMeshContext) {
		ExportTagToContentRule leftpad = new ExportTagToContentRule(
				siteMeshContext, contentProperty.getChild("leftpad"), false);
		defaultState.addRule("leftpad", leftpad);
		ExportTagToContentRule rightpad = new ExportTagToContentRule(
				siteMeshContext, contentProperty.getChild("rightpad"), false);
