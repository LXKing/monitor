...
import com.edata.godp.domain.device.DataLog;
import com.edata.godp.domain.device.DeviceBindUserRequest;
import com.edata.godp.domain.device.DeviceStatusRequest;
import com.edata.godp.domain.device.DeviceStatusResponse;
import com.edata.godp.domain.device.LoadDataLogRequest;
import com.edata.godp.domain.device.LoadDataLogResponse;
import com.edata.godp.domain.device.SetDataLogRequest;
import com.edata.godp.domain.drivingrecorder.AccidentDoubt;
import com.edata.godp.domain.drivingrecorder.LocateLog;
import com.edata.godp.domain.drivingrecorder.LoginLogoutLog;
import com.edata.godp.domain.drivingrecorder.ParameterChangeLog;
import com.edata.godp.domain.drivingrecorder.PowerSupplyLog;
import com.edata.godp.domain.drivingrecorder.QueryAccidentDoubtLogRequest;
import com.edata.godp.domain.drivingrecorder.QueryAccidentDoubtLogResponse;
import com.edata.godp.domain.drivingrecorder.QueryDrivingRecorderInfoRequest;
import com.edata.godp.domain.drivingrecorder.QueryDrivingRecorderInfoResponse;
import com.edata.godp.domain.drivingrecorder.QueryLocateLogRequest;
import com.edata.godp.domain.drivingrecorder.QueryLocateLogResponse;
import com.edata.godp.domain.drivingrecorder.QueryLoginLogRequest;
import com.edata.godp.domain.drivingrecorder.QueryLoginLogResponse;
import com.edata.godp.domain.drivingrecorder.QueryParameterLogRequest;
import com.edata.godp.domain.drivingrecorder.QueryParameterLogResponse;
import com.edata.godp.domain.drivingrecorder.QueryPowerLogRequest;
import com.edata.godp.domain.drivingrecorder.QueryPowerLogResponse;
import com.edata.godp.domain.drivingrecorder.QuerySpeedLogRequest;
import com.edata.godp.domain.drivingrecorder.QuerySpeedLogResponse;
import com.edata.godp.domain.drivingrecorder.QuerySpeedStatusLogRequest;
import com.edata.godp.domain.drivingrecorder.QuerySpeedStatusLogResponse;
import com.edata.godp.domain.drivingrecorder.QueryTimeoutLogRequest;
import com.edata.godp.domain.drivingrecorder.QueryTimeoutLogResponse;
import com.edata.godp.domain.drivingrecorder.SpeedLog;
import com.edata.godp.domain.drivingrecorder.SpeedStatusLog;
import com.edata.godp.domain.drivingrecorder.TimeoutDriving;
...
import com.edata.godp.domain.instruct.FetchInstructRequest;
import com.edata.godp.domain.instruct.FetchInstructResponse;
import com.edata.godp.domain.instruct.InstructInfo;
import com.edata.godp.domain.instruct.QueryInstructRequest;
import com.edata.godp.domain.instruct.QueryInstructResponse;
import com.edata.godp.domain.instruct.SendInstructRequest;
...
import com.edata.godp.domain.multimedia.MultimediaInfo;
import com.edata.godp.domain.multimedia.QueryMultimediaRequest;
import com.edata.godp.domain.multimedia.QueryMultimediaResponse;
import com.edata.godp.domain.multimedia.ReadMultimediaRequest;
import com.edata.godp.domain.multimedia.ReadMultimediaResponse;
...
import com.edata.godp.domain.statistics.CurrentOnlineOfflineStatisticsRequest;
import com.edata.godp.domain.statistics.CurrentOnlineOfflineStatisticsResponse;
import com.edata.godp.domain.statistics.HistoryOnlineOfflineStatisticsRequest;
import com.edata.godp.domain.statistics.HistoryOnlineOfflineStatisticsResponse;
import com.edata.godp.domain.statistics.HistoryOnlineTimeStatisticsRequest;
import com.edata.godp.domain.statistics.HistoryOnlineTimeStatisticsResponse;
import com.edata.godp.domain.statistics.MileageOilCountRequest;
import com.edata.godp.domain.statistics.MileageOilCountResponse;
import com.edata.godp.domain.statistics.MileageOilCountResult;
import com.edata.godp.domain.track.CountTrackRequest;
import com.edata.godp.domain.track.CountTrackResponse;
import com.edata.godp.domain.track.LoadTrackRequest;
import com.edata.godp.domain.track.LoadTrackResponse;
import com.edata.godp.domain.track.Track;
...
import com.edata.monitor.dao.devicedata.AccidentDoubtLogDto;
import com.edata.monitor.dao.devicedata.DrivingRecorderInfoDto;
import com.edata.monitor.dao.devicedata.LocateLogDto;
import com.edata.monitor.dao.devicedata.LoginLogDto;
import com.edata.monitor.dao.devicedata.ParameterLogDto;
import com.edata.monitor.dao.devicedata.PhotoInfoDto;
import com.edata.monitor.dao.devicedata.PowerLogDto;
import com.edata.monitor.dao.devicedata.SpeedLogDto;
import com.edata.monitor.dao.devicedata.SpeedStatusLogDto;
import com.edata.monitor.dao.devicedata.TimeoutLogDto;
...
public class GodpDao implements IGodpDao {
	...
	public List<String> historyOnlineOfflineStatistics(List<String> numbers, Date start, Date end) throws Exception {
		...
		HistoryOnlineOfflineStatisticsResponse response = GodpPortal.execute(HistoryOnlineOfflineStatisticsResponse.class, request,
				"statistics.history.onlineoffline");
	...
	public Map<String, Integer> historyOnlineTimeStatistics(List<String> numbers, Date start, Date end) throws Exception {
		...
		HistoryOnlineTimeStatisticsResponse response = GodpPortal.execute(HistoryOnlineTimeStatisticsResponse.class, request,
				"statistics.history.onlinetime");
	...
	public List<String> currentOnlineOfflineStatistics(List<String> numbers) throws Exception {
		...
		CurrentOnlineOfflineStatisticsResponse response = GodpPortal.execute(CurrentOnlineOfflineStatisticsResponse.class, request,
				"statistics.current.onlineoffline");
