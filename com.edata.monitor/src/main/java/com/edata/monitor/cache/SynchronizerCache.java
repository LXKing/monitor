...
import com.edata.monitor.domain.cache.DeviceInstruct;
import com.edata.monitor.domain.cache.DeviceInstructSender;
import com.edata.monitor.domain.instruct.DeviceInAreaInfo;
import com.edata.monitor.service.SyncInstructService;
...
public class SynchronizerCache {
	...
	private static void routeAreaSync(DeviceInAreaInfo info) {
		...
		// {"areaId":"23","flag":"435","startTime":"2015-09-29 10:00:00","endTime":"2016-09-29 10:00:00","sections":[{"pointId":"34","sectionId":"23","lat":"23.34534","lng":"114.546456","width":"30","flag":"232","maxTime":"300","minTime":"120","maxSpeed":"120","overspeedSeconds":"5"}]}
	...
	private static void polygonAreaSync(DeviceInAreaInfo info) {
		...
		if (!polygonArea.isDeviceCatch())
			return;
		// {"areaId":"23","flag":"35445","startTime":"2015-09-29 00:00:00","endTime":"2015-10-29 00:00:00","maxSpeed":"120","overspeedSeconds":"5","points":[{"lat":"23.4364557","lng":"113.45465"}]}
		Map<String, Object> map = new HashMap<String, Object>();
	...
	private static void rectangleAreaSync(DeviceInAreaInfo info) {
		...
		if (!rectangleArea.isDeviceCatch())
			return;
		// {"action":"0","areas":[{"areaId":"1","flag":"123","ulLat":"23.322523","ulLng":"114.435443","brLat":"24.354435","brLng":"115.354353","startTime":"2015-09-28 00:00:00","endTime":"2015-10-28 00:00:00","maxSpeed":"120","overspeedSeconds":"5"}]}
		Map<String, Object> map = new HashMap<String, Object>();
	...
	private static void circleAreaSync(DeviceInAreaInfo info) {
		...
		if (!circleArea.isDeviceCatch())
			return;
		// {"action":"1","areas":[{"areaId":"1","flag":"1","lat":"23.234234","lng":"113.534546","radius":"500","startTime":"15-09-24 00:00:00","endTime":"15-09-25 00:00:00","maxSpeed":"80","overspeedSeconds":"10"}]
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("action", info.getAction());
