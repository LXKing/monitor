...
<script type="text/javascript"
	src="<%=request.getContextPath()%>/resources/js/center/deviceData/multimediaEventReport.js"></script>
</head>
<body>
	<div class="mon-toolbar metro-gray">
		<div class="title mon-3x">多媒体事件报告列表</div>
	...
	<div id="gridMultimediaEventReport"></div>
</body>
</html>