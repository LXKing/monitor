...
<script type="text/javascript"
	src="<%=request.getContextPath()%>/resources/js/statistics/driving/sectionOverspeed.js"></script>
</head>
<body>
	<div id="chart" style="height: 300px; width: 98%;"></div>
	<div class="mon-toolbar metro-gray">
		<div class="title mon-3x">车辆路段超速统计</div>
	...
	<div id="gridSectionOverspeed"></div>
</body>
</html>