...
<head>
    ...
    <script type="text/javascript"
            src="<%=request.getContextPath()%>/resources/js/statistics/driving/areaOverspeed.js"></script>
</head>
<body>
<div id="chart" style="height: 300px; width: 98%;"></div>
<div class="mon-toolbar metro-gray">
    <div class="title mon-3x">车辆区域超速统计</div>
